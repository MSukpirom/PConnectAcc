...
def get_districts(request):
    ...
    district_data = [{'id': district.id, 'name_th': district.name_th} for district in districts]
    return JsonResponse(district_data, safe=False)

def get_subdistricts(request):
    district_id = request.GET.get('district_id')
    subdistricts = Subdistrict.objects.filter(district=district_id)
    subdistrict_data = [{'id': subdistrict.id, 'name_th': subdistrict.name_th} for subdistrict in subdistricts]
    return JsonResponse(subdistrict_data, safe=False)