...
# def forms_client(request):
    ...
    #     return redirect('AccountTask:checkdata')
...
def update_client(request, pk):
    ...
    if request.method == 'POST':
        ...
        return redirect("AccountTask:list_client")
...
#     type_job.delete()
#     return redirect("AccountTask:list_type_job")
...
#         return redirect('AccountTask:list_document_detail')
